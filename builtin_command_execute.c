...
/**
 * _penv_var - Display enviroment variable
 * @cmd: parsed command
 * @st: status of last command executed
 * Return: Always 0
 */
...
/**
 * _history - display history of user input on simple_shell
 * @c: parsed command
 * @st: status of last command executed
 * Return: 0 success or -1 if fail
 */
int _history(__attribute__((unused)) char **c, __attribute__((unused)) int st)
{
